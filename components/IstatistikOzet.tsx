    ...
    <PixelCard>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="border-2 border-[#000000] px-3 py-2 text-center" style={{ background: "#A8A8A8" }}>
          <div className="font-[family-name:var(--font-pixel)] text-[8px] text-[#6878A8]">BUGÜN GÖREV</div>
        ...
        <div className="border-2 border-[#000000] px-3 py-2 text-center" style={{ background: "#A8A8A8" }}>
          <div className="font-[family-name:var(--font-pixel)] text-[8px] text-[#6878A8]">HAFTA POMODORO</div>
          <div className="font-[family-name:var(--font-pixel)] text-2xl" style={{ color: "#E01828" }}>
            {veri.haftaPomodoro}
          </div>
        </div>
        <div className="border-2 border-[#000000] px-3 py-2 text-center" style={{ background: "#A8A8A8" }}>
          <div className="font-[family-name:var(--font-pixel)] text-[8px] text-[#6878A8]">HAFTA GÖREV</div>
          <div className="font-[family-name:var(--font-pixel)] text-2xl" style={{ color: "#00A800" }}>
            {veri.haftaGorev.tamamlanan}/{veri.haftaGorev.toplam}
          </div>
        </div>
        <div className="border-2 border-[#000000] px-3 py-2 text-center" style={{ background: "#A8A8A8" }}>
          <div className="font-[family-name:var(--font-pixel)] text-[8px] text-[#6878A8]">AY GÖREV</div>
